...
export interface ISignUpUseCase {
    handleSignUp(input: SignUpUseCaseInput): Promise<SignUpUseCaseOutput | null>;
}

export interface IUpdateUserUseCase {
    handleUpdateUser(input: UpdateUserUseCaseInput): Promise<UpdateUserUseCaseOutput | null>;
}

export interface IDeleteUserUseCase {
    handleDeleteUser(input: DeleteUserUseCaseInput): Promise<DeleteUserUseCaseOutput | null>;
}